...
public class HttpProtocol extends AbstractProxyProtocol {
     ...
     * 通过 #setHttpBinder(httpBinder) 方法，Dubbo SPI 调用设置
     */
    ...
    protected <T> T doRefer(final Class<T> serviceType, final URL url) throws RpcException {
        ...
        // 创建执行器 SimpleHttpInvokerRequestExecutor 对象，jdk httpClient
        ...
        // 创建执行器 HttpComponentsHttpInvokerRequestExecutor 对象， apacheClient对象
